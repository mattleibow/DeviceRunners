    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!fs.existsSync(avdPath) || forceAvdCreation) {
                ...
                yield exec.exec(`sh -c \\"ls -l /home/runner/.android"`);
                yield exec.exec(`sh -c \\"ls -l /home/runner/.android/avd"`);
                yield exec.exec(`sh -c \\"ls -l /home/runner/.android/avd/test.avd"`);
                yield exec.exec(`sh -c \\"cat /home/runner/.android/avd/test.avd/config.ini"`);
