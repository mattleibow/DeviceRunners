...
public class TestCaseViewModel : AbstractBaseViewModel
{
	...
	readonly Dictionary<string, TestResultViewModel> _testResults = new();

	public TestCaseViewModel(string assemblyFileName, ITestCase testCase)
	{
	...
	public string DisplayName =>
		_testResults.Count > 1
			? TestResult?.TestResultMessage?.Test?.DisplayName ?? TestCase.DisplayName
