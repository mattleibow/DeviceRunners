...
namespace Xunit.Runner.Devices.XHarness.Maui
{
	public abstract class MauiTestInstrumentation : Instrumentation
	{
		...
		public RunnerOptions Options { get; private set; } = null!;
		...
		public override async void OnStart()
		{
			...
			Options = Services.GetRequiredService<RunnerOptions>();
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		Task<Bundle> RunTestsAsync()
		{
			...
			else
			{
				...
				var runner = Services.GetRequiredService<HeadlessXHarness>();
